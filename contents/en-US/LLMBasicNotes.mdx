...
description: 'Technical notes on Large Language Model (LLM): covering generative AI fundamentals, ChatGPT principles, scaling laws and emergent abilities, LangChain toolchain, AI Agent orchestration patterns, guardrails, and MCP servers'
author: 'Sabertaz'
date: 2025-11-11
