---
layout: post
title: 'LLM Basic Notes'
description: 'Comprehensive technical notes on Large Language Models (LLM): covering generative AI fundamentals, ChatGPT principles, scaling laws and emergent abilities, LangChain toolchain, AI Agent orchestration patterns, guardrails, and MCP servers.'
author: 'Sabertaz'
date: 2025-11-11
thumbnail: '/photos/labtop-ai-workspace.jpg'
tags:
  - AI
  - LLM
  - Agent
