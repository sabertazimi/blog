  ...
  return (
    <div
      ...
      className={cn(
        ...
        'prose-headings:text-primary prose-headings:font-serif prose-headings:font-semibold prose-headings:text-balance prose-headings:scroll-mt-20 prose-headings:relative',
        ...
        'prose-a:text-primary prose-strong:text-primary prose-em:font-serif prose-blockquote:font-serif',
