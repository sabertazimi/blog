  ...
  return (
    <div
      className={cn(
        ...
        'prose-headings:before:absolute prose-headings:before:right-0 prose-headings:before:text-primary/50 prose-headings:before:content-["#"]',
        'prose-headings:before:opacity-0 prose-headings:hover:before:opacity-100 prose-headings:before:transition-opacity',
